...
class Person(TypedDict):
    first_person_singular: Option
    second_person_singular: Option
    second_person_singular_polite: Option
    third_person_singular: Option
    first_person_plural: Option
    second_person_plural: Option
    second_person_plural_polite: Option
    third_person_plural: Option
