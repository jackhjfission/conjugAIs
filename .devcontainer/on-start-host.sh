...
cp /home/aprendiz/workspace/.devcontainer/.pre-commit /home/aprendiz/workspace/.git/hooks/pre-commit

# keep poetry envs up to date
echo "Installing poetry environments..."
find /home/aprendiz/workspace -name "pyproject.toml" -type f | while read -r lockfile; do
...
find /home/aprendiz/workspace -maxdepth 2 -name "pyproject.toml" -type f | while read -r pyproject; do
